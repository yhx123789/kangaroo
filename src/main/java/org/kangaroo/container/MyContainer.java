...
//        String cfgPath = "/home/zt/test/kangaroo.cfg";
    ...
    public static void doTest(){
        ...
        HellTest hellTest = (HellTest) MyContainer.getContext().getBean("helloTest");
    ...
    public void start(KangarooConfig initParams) {
        local = Node.createServiceNode(initParams.getZookeeperAddress(), initParams.getNs(), initParams.getSystem(), initParams.getEnv());
...
//    }
    ...
    public void refreshContext(KangarooConfig initParams) {
        ...
        context.getEnvironment().getPropertySources().addFirst(new PropertiesPropertySource("localProperties", initParams.getProperties()));
